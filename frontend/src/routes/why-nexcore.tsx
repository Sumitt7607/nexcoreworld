...
export const Route = createFileRoute('/why-nexcore')({
  component: WhyNexcore,
})
...
function WhyNexcore() {
  ...
  const faqs = [
    { q: "Do I get a platform login to access my data?", a: "Nexcore delivers data directly to your preferred format or CRM. We focus on providing the data rather than making you learn another platform." },
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-[#0f172a] mb-6 leading-tight">
              Why B2B Teams <br />Choose <span className="text-[#004ab0]">Nexcore</span> <br />Over CDPs
            </h1>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <span className="text-xs bg-[#004ab0] px-2 py-1 rounded-full">Nexcore: 72hr before delivery</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-[#f8faff]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Precision data intelligence services purpose-built for tech and IT companies targeting Nexcore Technologies high-value B2B buyers.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-8">
              When accuracy and freshness are non-negotiable, B2B tech leaders choose Nexcore over platforms that recycle the same stale lists to hundreds of clients.
            </p>
